"""
Django settings for DjangoFirstPrj project.
...
SECRET_KEY = 'django-insecure-$8u3rk=6fi0knl7jt^_pt)@maa@o&y8j!6e5sd678_+1q7#1(q'
...
ROOT_URLCONF = 'DjangoFirstPrj.urls'
...
WSGI_APPLICATION = 'DjangoFirstPrj.wsgi.application'
